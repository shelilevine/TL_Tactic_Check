...
def cleanup_pixel(raw_impression_pixel):
    #decode escaped characters and remove quotations
...
with open(tactic_file) as csv_file:
    ...
    for row in csv_reader:
        ...
        if line_count == 0:
            ...
            imp_pixels[tactic] = impression_pixel
    ...
    for pixel in imp_pixels[tactic]:
        ...
        #get status codes for each pixel call
            ...
            if get_status_codes(pixel) in ['2','3']:
                ...
                print count, pixel
                print count
                print count, get_status_codes(pixel)
...
print_list = raw_input('Do you want to print a list of failed pixels? Type y/n')
if print_list == 'y':
